...
function Sidebar() {
  return (
    ...
    <ul id="social-sidebar">
        ...
        <li>
            <a href="https://www.linkedin.com/in/sharan-sampath-kumar-10b1a5208?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3B%2F0%2FkZ6esTpyLw6CV3kWanA%3D%3D" target="_blank" rel="noreferrer"><FiLinkedin color='#333' fontSize="100%" /><span>LinkedIn</span></a>
        </li>
        <li>
